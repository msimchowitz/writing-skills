...
Several distinct dimensions organize the patterns in this article. Collapsing
them into a single score would hide the difference between factual error,
generic style, and a mismatch with one reader's needs.
...
The selection of detail in reader-centered prose reveals what the writer
assumes about prior knowledge and intended use. At sentence scale, familiar
...
analysis, and optimistic conclusions share a common effect: they substitute
rhetorical form for evidential support. Lists and headings cause a related
problem when they distribute equal weight across ideas with different roles.
...
title or section-summary abstract can therefore misrepresent the argument even
when every sentence in the body remains unchanged.
...
Paragraph endings add another source of emphasis: a natural ending completes
the current inference, whereas a generic summary or slogan only imitates
closure.
