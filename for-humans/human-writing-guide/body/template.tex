...
\subsection{Separate preamble files by purpose}
...
\subsection{Choose paragraph and emphasis commands by their effect}
...
\subsection{Use color edits only during review}
...
\begin{verbatim}
\begin{algorithm}[t]
\caption{Critic update from replay data}\label{alg:update}
\begin{algorithmic}[1]
...
\subsection{Publish only useful title metadata}
