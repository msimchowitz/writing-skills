...
Human readers favor grammatical coherence across a whole sentence over the
local fluency of adjacent words. ``Result needs'' is a natural bigram, but
``setup that a result needs'' makes \emph{result} the subject of the relative
clause and pushes \emph{setup} into object position. Write ``setup that is
required by the result'' when setup should remain in focus. The passive voice
is useful here because it preserves the sentence's grammatical center.
...
\subsection{Ensure each paragraph develops one inference}
...
\subsection{Use sentence starters as scaffolding}
