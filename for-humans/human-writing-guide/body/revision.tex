...
Read only what a skimming reader sees. Start with the title and abstract,
follow the section headings and figure captions, and finish with the
...
Check whether each section answers one question and whether the sequence of
questions is necessary. Remove duplicate motivation and contribution lists.
Move secondary material out of the path of the main result.
...
Give each paragraph one inferential job. Put setup near the result that needs
it. Move implementation detail, complete proofs, and secondary sweeps to the
appendix when the main argument remains self-contained.
